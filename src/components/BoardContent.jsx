...
export default function BoardContent({ user, onBack, embedded }) {
  ...
  return (
    <div className={embedded ? 'board-content board-content-embedded' : 'board-content'}>
      {onBack && (
        <div className="board-back-row">
          <button type="button" className="board-back-btn" onClick={onBack}>← 목록으로</button>
        </div>
      )}
